...
### Challenge: Full Judge and Jury Evaluation Pipeline
...
1. Pipeline runs without errors on the provided dataset
2. Implements both single-judge and multi-judge (jury) evaluation patterns
3. Handles judge disagreement using bootstrap confidence intervals or equivalent
4. Uses an appropriate multi-dimensional scoring rubric (at least 3 metrics)
5. Learner explains when jury evaluation beats single-judge evaluation and why
